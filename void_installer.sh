...
sudo xbps-install -S vim base-devel libX11-devel libXft-devel font-awesome5 libXinerama-devel python3-pip git gcc mpv xorg sxhkd htop firefox kitty lf git
fc-cache -fv
sudo fc-cache -fv
